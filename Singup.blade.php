...
<style id="applicationStylesheet" type="text/css">
	.mediaViewInfo {
		--web-view-name: Signup Form;
		--web-view-id: Signup_Form;
		--web-scale-on-resize: true;
		--web-enable-deep-linking: true;
	}
	:root {
		--web-view-ids: Signup_Form;
	}
	* {
		margin: 0;
		padding: 0;
	...
	#Sign_Up_Already_have_an_accoun {
		position: absolute;
		left: 344px;
		top: 22px;
		overflow: visible;
	...
	.back__27_ {
		...
		width: 14.884px;
		height: 8.239px;
		transform: translate(0px, 0px) matrix(1,0,0,1,154.0356,22.9146) rotate(180deg);
	...
	#Group_390 {
		...
		--web-animation: fadein 0.3s ease-out;
		--web-action-type: page;
		--web-action-target: Offer_Posted_after_verification.html;
		cursor: pointer;
	}
	#Group_302_cr {
		position: absolute;
	...
	.back__27__cv {
		...
		width: 14.884px;
		height: 8.239px;
		transform: translate(0px, 0px) matrix(1,0,0,1,285.0767,29.8112) rotate(180deg);
		transform-origin: center;
		left: 0px;
		top: 0px;
	}
...
<div id="Signup_Form">
	...
	<svg class="Path_1137" viewBox="0 0 1920 1">
		<path fill="rgba(0,0,0,0)" id="Path_1137" d="M 0 0 L 1920 0">
		</path>
	</svg>
	<div id="Group_415">
		<div id="Group_337">
				...
				<div id="Group_339">
					<div id="Group_340">
						<svg class="Rectangle_628">
							<rect fill="rgba(255,255,255,1)" stroke="rgba(0,123,255,0.749)" stroke-width="2px" stroke-linejoin="miter" stroke-linecap="butt" stroke-dasharray="5" stroke-dashoffset="0" stroke-miterlimit="4" shape-rendering="auto" id="Rectangle_628" rx="0" ry="0" x="0" y="0" width="1130" height="491">
							</rect>
						</svg>
					</div>
				</div>
				<div id="Sign_Up_Already_have_an_accoun">
					<span>Sign Up</span><br><span style="font-style:normal;font-weight:normal;font-size:25px;">Already have an account? </span><span style="font-style:normal;font-weight:normal;font-size:25px;color:rgba(68,64,161,1);">Log In</span>
				</div>
			</div>
		</div>
    ...
    <div class="form-group">
     ...
     <input type="email" placeholder="Enter Email" name="email" class="form-control" />
		...
		<div id="Group_386">
			<div id="Type_your_Email_again">
            <form method="post" action="{{ url('/main/checklogin') }}">
    {{ csrf_field() }}
    <div class="form-group">
     <!-- <label>Enter Email</label> -->
     <input type="email" placeholder="Type_your_Email_again" name="email" class="form-control" />
    </div>

   </form>
				<!-- <span>Type your Email again</span> -->
			</div>
     ...
     <input type="password" placeholder="Enter Password"  name="password" class="form-control" />
		...
		<div id="Group_388">
			<div id="Retype_your_password">
            <div class="form-group">
     <input type="password" placeholder="Retype_your_password"  name="password" class="form-control" />
    </div>
				<!-- <span>Retype your password</span> -->
			</div>
			<svg class="Line_4_co" viewBox="0 0 290 2">
				<path fill="transparent" stroke="rgba(227,238,255,1)" stroke-width="2px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Line_4_co" d="M 0 0 L 290 0">
				</path>
			</svg>
		</div>
			...
			<div id="Group_302_cr">
				<div id="Group_351_cs">
					<svg class="Rectangle_62_ct">
						<rect fill="rgba(102,96,255,1)" id="Rectangle_62_ct" rx="8" ry="8" x="0" y="0" width="330" height="69">
						</rect>
					</svg>
				</div>
		...
		<div onclick="application.goToTargetView(event)" id="Group_391">
			<div id="Group_302_cx">
				<div id="Group_351_cy">
					<svg class="Rectangle_62_cz">
						<rect fill="rgba(35,104,241,1)" id="Rectangle_62_cz" rx="8" ry="8" x="0" y="0" width="330" height="69">
						</rect>
					</svg>
				</div>
				...
				<svg class="back__27__c" viewBox="0 0 14.884 8.239">
					<path fill="rgba(53,115,239,1)" id="back__27__c" d="M 14.884033203125 3.244223833084106 L 3.350384712219238 3.244223833084106 L 5.356963157653809 1.237671256065369 L 4.119340419769287 0 L 0 4.119363307952881 L 4.119340419769287 8.238741874694824 L 5.356963157653809 7.001100540161133 L 3.350384712219238 4.994472503662109 L 4.704365730285645 4.994472503662109 L 14.884033203125 4.994472503662109 L 14.884033203125 3.244223833084106 Z">
					</path>
				</svg>
			</div>
		</div>
	</div>
	<svg class="Rectangle_6_c">
		<rect fill="rgba(238,238,238,1)" id="Rectangle_6_c" rx="0" ry="0" x="0" y="0" width="1" height="45">
		</rect>
	</svg>
	<svg class="Rectangle_6_c">
		<rect fill="rgba(238,238,238,1)" id="Rectangle_6_c" rx="0" ry="0" x="0" y="0" width="1" height="45">
	...
	<div id="Searchbar" class="Searchbar">
		...
		<svg style="width:inherit;height:inherit;overflow:visible;">
			<rect fill="url(#Mask_ea_pattern)" width="100%" height="100%"></rect>
				<pattern elementId="Mask_ea" id="Mask_ea_pattern" x="0" y="0" width="100%" height="100%">
					<image x="0" y="0" width="100%" height="100%" href="Mask_ea_pattern.png" xlink:href="Mask_ea_pattern.png"></image>
				</pattern>
				</svg>
			</div>
