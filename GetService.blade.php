...
<title>GetServicesForm</title>
<style id="applicationStylesheet" type="text/css">
	.mediaViewInfo {
		--web-view-name: GetServicesForm;
		--web-view-id: GetServicesForm;
		--web-scale-on-resize: true;
		--web-enable-deep-linking: true;
	}
	:root {
		--web-view-ids: GetServicesForm;
	}
	* {
		margin: 0;
		padding: 0;
	...
	#Copyright___2019_Devdesign__Al {
		position: absolute;
		left: 405px;
		top: 1843px;
		overflow: visible;
	...
	#Design___Development_By_Devdes {
		position: absolute;
		left: 1211px;
		top: 1843px;
		overflow: visible;
	...
	.Path_1120 {
		filter: drop-shadow(0px 16px 32px rgba(51, 52, 87, 0.161));
		overflow: visible;
		position: absolute;
		width: 1219px;
		height: 1187.746px;
	...
	#Group_302 {
		...
		--web-action-target: Signup_Form.html;
		cursor: pointer;
	}
	#Group_351 {
		position: absolute;
	...
	.back__27_ {
		...
		width: 15px;
		height: 8.303px;
		transform: translate(-0.169px, 0px) matrix(1,0,0,1,171.0808,29.7791) rotate(180deg);
	...
	#eye_for_ebony_OeXcIHFwtsM_unsp {
		position: absolute;
		width: 405px;
		height: 474px;
		left: 62px;
	...
	.back__27__da {
		...
		width: 15px;
		height: 8.303px;
		transform: translate(-75.538px, -22px) matrix(1,0,0,1,171.2272,29.7791) rotate(3deg);
		transform-origin: center;
		left: 0px;
		top: 0px;
	}
	#Group_362 {
		...
		--web-animation: fadein 0.3s ease-out;
		--web-action-type: page;
		--web-action-target: Sub_Category_Onclick_details.html;
		cursor: pointer;
	}
	#Group_351_dc {
		position: absolute;
	...
	.back__27__dg {
		...
		width: 15px;
		height: 8.303px;
		transform: translate(0.462px, 0px) matrix(1,0,0,1,171.2272,29.7791) rotate(3deg);
		transform-origin: center;
		left: 0px;
		top: 0px;
	}
	#Get_Easy_and_Affordable_help {
		position: absolute;
		left: 667px;
		top: 506px;
		overflow: hidden;
	...
	#HOME {
		...
		--web-animation: fadein 0.3s ease-out;
		--web-action-type: page;
		--web-action-target: ContactUs.html;
		cursor: pointer;
		line-height: 18px;
		margin-top: -1px;
		text-align: left;
...
<div id="GetServicesForm">
	...
	<svg class="Line_8" viewBox="0 0 1920 1">
		<path fill="transparent" stroke="rgba(2,192,208,1)" stroke-width="1px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Line_8" d="M 0 0 L 1920 0">
		</path>
	</svg>
	<svg class="Path_1081" viewBox="0 -100 1920 1359.639">
		<path fill="rgba(48,113,255,1)" id="Path_1081" d="M 0 -100 C 0 -100 495.4752807617188 56.28037643432617 975.4752807617188 56.28037643432617 C 1455.475341796875 56.28037643432617 1920 -100 1920 -100 L 1920 1259.639282226563 L 0 1259.639282226563 L 0 -100 Z">
		</path>
	</svg>
	<div id="Copyright___2019_Devdesign__Al">
		<span>Copyright © 2019 Devdesign. All Rights Reserved.</span>
	</div>
	<div id="Design___Development_By_Devdes">
		<span>Design & Development By Devdesgin.studio</span>
	</div>
	<div id="Group_303">
		<svg class="Path_1120" viewBox="0 0 1123 1091.746">
			<path fill="rgba(255,255,255,1)" id="Path_1120" d="M 0 0 L 1123 0 L 1123 1091.746215820313 L 553.1014404296875 1091.746215820313 L 0 1091.746215820313 L 0 0 Z">
			</path>
		</svg>
		<div id="Get_Services">
		...
		<div id="Group_23_b">
			<div id="Full_Name_Here">
			<input type="text" placeholder="Full_Name_Here" name="Full_Name_Here" class="form-control" />
		...
		<div id="Group_24_b">
			...
			<!-- <svg class="Line_4_b" viewBox="0 0 290 2">
				<path fill="transparent" stroke="rgba(227,238,255,1)" stroke-width="2px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Line_4_b" d="M 0 0 L 290 0">
				</path>
			</svg> -->
		</div>
		<div id="Group_25_b">
			<div id="Phone_No">
			<input type="tel" id="Phone_No" placeholder="Phone_No" name="Phone_No" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required class="form-control"/>
			
				<!-- <span>Phone No</span> -->
			</div>
			<!-- <svg class="Line_4_cb" viewBox="0 0 290 2">
				<path fill="transparent" stroke="rgba(227,238,255,1)" stroke-width="2px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Line_4_cb" d="M 0 0 L 290 0">
				</path>
			</svg> -->
		</div>
		<div id="Description">
		...
		<svg class="Line_4_cd" viewBox="0 0 612 2">
			<path fill="transparent" stroke="rgba(227,238,255,1)" stroke-width="2px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Line_4_cd" d="M 0 0 L 612 0">
			</path>
		</svg>
		<div onclick="application.goToTargetView(event)" id="Group_302">
			<div id="Group_351">
				<svg class="Rectangle_62">
					<rect fill="rgba(0,123,255,1)" id="Rectangle_62" rx="8" ry="8" x="0" y="0" width="216" height="69">
					</rect>
				</svg>
			</div>
			<div id="Post">
			...
			<svg class="back__27_" viewBox="0 0 15 8.303">
				<path fill="rgba(255,255,255,1)" id="back__27_" d="M 15 3.269500732421875 L 3.376488924026489 3.269500732421875 L 5.398701190948486 1.247314453125 L 4.151435852050781 0 L 0 4.151458740234375 L 4.151435852050781 8.302932739257813 L 5.398701190948486 7.055648803710938 L 3.376488924026489 5.03338623046875 L 15 5.03338623046875 L 15 3.269500732421875 Z">
				</path>
			</svg>
		</div>
		<div id="Group_26_cj">
			...
			<!-- <svg class="Line_4_cl" viewBox="0 0 290 2">
				<path fill="transparent" stroke="rgba(227,238,255,1)" stroke-width="2px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Line_4_cl" d="M 0 0 L 290 0">
				</path>
			</svg> -->
		</div>
		<img id="eye_for_ebony_OeXcIHFwtsM_unsp" src="eye_for_ebony_OeXcIHFwtsM_unsp.png" srcset="eye_for_ebony_OeXcIHFwtsM_unsp.png 1x, eye_for_ebony_OeXcIHFwtsM_unsp@2x.png 2x">
		<div id="Group_352">
			<div id="Select_Job_Category">
			<input type="text" placeholder="Select_Job_Category" name="Select_Job_Category" class="form-control" />
				<!-- <span>Select Job Category</span> -->
			</div>
			<!-- <svg class="Line_4_cp" viewBox="0 0 290 2">
				<path fill="transparent" stroke="rgba(227,238,255,1)" stroke-width="2px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Line_4_cp" d="M 0 0 L 290 0">
				</path>
			</svg> -->
		</div>
		<div id="Group_353">
			<div id="Select_Job_Sub_Category">
			<input type="text" placeholder="Select_Job_Sub_Category" name="Select_Job_Sub_Category" class="form-control" />
				<!-- <span>Select Job Sub Category</span> -->
			</div>
			<svg class="Line_4_cs" viewBox="0 0 290 2">
				<path fill="transparent" stroke="rgba(227,238,255,1)" stroke-width="2px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Line_4_cs" d="M 0 0 L 290 0">
				</path>
			</svg>
		</div>
		<div id="Group_354">
			...
			<!-- <svg class="Line_4_cv" viewBox="0 0 290 2">
				<path fill="transparent" stroke="rgba(227,238,255,1)" stroke-width="2px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Line_4_cv" d="M 0 0 L 290 0">
				</path>
			</svg> -->
		</div>
		<div id="Group_355">
			...
			<!-- <svg class="Line_4_cy" viewBox="0 0 290 2">
				<path fill="transparent" stroke="rgba(227,238,255,1)" stroke-width="2px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Line_4_cy" d="M 0 0 L 290 0">
				</path>
			</svg> -->
		</div>
		<div id="Group_356">
			...
			<!-- <svg class="Line_4_c" viewBox="0 0 612 2">
				<path fill="transparent" stroke="rgba(227,238,255,1)" stroke-width="2px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Line_4_c" d="M 0 0 L 612 0">
				</path>
			</svg> -->
		</div>
		<div id="Group_357">
			<div id="Charges_per_hour__optional_">
			<input type="text" placeholder="Charges_per_hour (optional)" name="Charges_per_hour__optional_" class="form-control" />
				<!-- <span>Charges per hour (optional)</span> -->
			</div>
			<!-- <svg class="Line_4_da" viewBox="0 0 290 2">
				<path fill="transparent" stroke="rgba(227,238,255,1)" stroke-width="2px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Line_4_da" d="M 0 0 L 290 0">
				</path>
			</svg> -->
		</div>
		<div id="Group_358">
			<div id="Total_Number_of_Hours">
			<input type="text" placeholder="Total_Number_of_Hours" name="Total_Number_of_Hours" class="form-control" />
				<!-- <span>Total Number of Hours</span> -->
			</div>
			<!-- <svg class="Line_4_db" viewBox="0 0 290 2">
				<path fill="transparent" stroke="rgba(227,238,255,1)" stroke-width="2px" stroke-linejoin="miter" stroke-linecap="butt" stroke-miterlimit="4" shape-rendering="auto" id="Line_4_db" d="M 0 0 L 290 0">
				</path>
			</svg> -->
		</div>
		<div id="Group_361">
			...
			<svg class="back__27__da" viewBox="0 0 15 8.303">
				<path fill="rgba(255,255,255,1)" id="back__27__da" d="M 15 3.269500732421875 L 3.376488924026489 3.269500732421875 L 5.398701190948486 1.247314453125 L 4.151435852050781 2.812244676090843e-17 L -2.101912258611546e-18 4.151458740234375 L 4.151435852050781 8.302932739257813 L 5.398701190948486 7.055648803710938 L 3.376488924026489 5.03338623046875 L 15 5.03338623046875 L 15 3.269500732421875 Z">
				</path>
			</svg>
		</div>
		<div onclick="application.goToTargetView(event)" id="Group_362">
			<div id="Group_351_dc">
				<svg class="Rectangle_62_dd">
					<rect fill="rgba(0,123,255,1)" id="Rectangle_62_dd" rx="8" ry="8" x="0" y="0" width="216" height="69">
					</rect>
				</svg>
				<svg class="Rectangle_650">
					<rect fill="rgba(0,123,255,1)" id="Rectangle_650" rx="8" ry="8" x="0" y="0" width="216" height="69">
					</rect>
				</svg>
			</div>
			<div id="Cancel_df">
			...
			<svg class="back__27__dg" viewBox="0 0 15 8.303">
				<path fill="rgba(0,123,255,1)" id="back__27__dg" d="M 15 3.269500732421875 L 3.376488924026489 3.269500732421875 L 5.398701190948486 1.247314453125 L 4.151435852050781 2.812244676090843e-17 L -2.101912258611546e-18 4.151458740234375 L 4.151435852050781 8.302932739257813 L 5.398701190948486 7.055648803710938 L 3.376488924026489 5.03338623046875 L 15 5.03338623046875 L 15 3.269500732421875 Z">
				</path>
			</svg>
		</div>
	</div>
	<div id="Get_Easy_and_Affordable_help">
		<span>Get Easy and Affordable help</span>
	</div>
	<div id="Get_services">
		<span>Get services</span>
	</div>
	<svg class="Path_1122" viewBox="0 0 1920 72.538">
		<path fill="rgba(33,34,63,1)" id="Path_1122" d="M 0 0 L 507.8125305175781 0 L 527.9912109375 13.35761547088623 L 1920 13.35761547088623 L 1920 72.5379638671875 L 1017.235046386719 72.5379638671875 L 672.6949462890625 72.5379638671875 L 0 72.5379638671875 L 0 0 Z">
		</path>
	</svg>
	...
	<svg class="Path_1134" viewBox="0 0 1920 1">
		<path fill="rgba(0,0,0,0)" id="Path_1134" d="M 0 0 L 1920 0">
		</path>
	</svg>
	<svg class="Rectangle_6">
		<rect fill="rgba(238,238,238,1)" id="Rectangle_6" rx="0" ry="0" x="0" y="0" width="1" height="45">
		</rect>
	</svg>
	...
	<img onclick="application.goToTargetView(event)" id="Image_30" src="Image_30.png" srcset="Image_30.png 1x, Image_30@2x.png 2x">
	<div id="Searchbar" class="Searchbar">
		<div id="Mask">
		<svg style="width:inherit;height:inherit;overflow:visible;">
			<rect fill="url(#Mask_eu_pattern)" width="100%" height="100%"></rect>
				<pattern elementId="Mask_eu" id="Mask_eu_pattern" x="0" y="0" width="100%" height="100%">
					<image x="0" y="0" width="100%" height="100%" href="Mask_eu_pattern.png" xlink:href="Mask_eu_pattern.png"></image>
				</pattern>
				</svg>
			</div>
